...
<div class="flex-grow-1 overflow-y-auto mb-3 mh-75">
    ...
    <div class="d-flex align-items-center justify-content-between p-3 mb-2 bg-white rounded shadow-sm border-start border-primary border-3">
        ...
        <div class="ms-3 flex-grow-1 me-4">
            ...
            <div class="text-primary fs-7 fw-semibold mb-0.5">{{ $details['package_name'] }}</div>
            @endif
...
<div class="border-top pt-3 bg-light p-3 rounded mt-auto">
    ...
    <a href="{{ route('checkout.view') }}" class="btn btn-primary w-100 py-2.5 rounded-pill fw-bold shadow-sm text-white d-flex align-items-center justify-content-center text-decoration-none gap-1">
