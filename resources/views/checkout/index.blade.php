        ...
        <div class="col-lg-5">
            <div class="card border border-light-subtle rounded-3 shadow-sm bg-white p-4 sticky-top" style="top: 2rem; z-index: 4;">
                ...
                <div class="d-flex justify-content-between mb-3">
                    ...
                    <span class="fw-bold text-dark" id="invoice-subtotal">₹{{ number_format($subtotal, 2) }}</span>
                </div>
                
                <div class="d-flex justify-content-between mb-3">
                    <span class="text-muted">GST / Healthcare Tax (18%)</span>
                    <span class="fw-bold text-dark" id="invoice-gst">₹{{ number_format($gst, 2) }}</span>
                </div>
                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <span class="fw-bold text-primary fs-3" id="invoice-total">₹{{ number_format($finalPayable, 2) }}</span>
                </div>
            </div>
        </div>
...
<script type="module">
    $(document).ready(function() {
        if (typeof window.jQuery !== 'undefined' && $('#invoice-total').length > 0) {
            // Emits an update check to trigger calculations from app.js instantly
