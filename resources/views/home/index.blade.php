                        ...
                        <div class="col-xl-6 col-lg-8 text-start">
                            ...
                            <div class="row g-4 mb-5 text-start">
                                <div class="col-sm-6 d-flex align-items-center gap-3">
                                    ...
                                    <div>
                                        <h6 class="fw-bold mb-0">CPAP & BiPAP</h6>
                                        <p class="small text-white-50 mb-0">Machines</p>
                                    </div>
                                </div>
                                <div class="col-sm-6 d-flex align-items-center gap-3">
                                    ...
                                    <div>
                                        <h6 class="fw-bold mb-0">Home Sleep</h6>
                                        <p class="small text-white-50 mb-0">Testing</p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-6 col-lg-8 text-start">
                            ...
                            <div class="row g-4 mb-5 text-start">
                                <div class="col-sm-6 d-flex align-items-center gap-3">
                                    ...
                                    <div>
                                        <h6 class="fw-bold mb-0">Full Face Masks</h6>
                                        <p class="small text-white-50 mb-0">Maximum Seal</p>
                                    </div>
                                </div>
                                <div class="col-sm-6 d-flex align-items-center gap-3">
                                    ...
                                    <div>
                                        <h6 class="fw-bold mb-0">Nasal Pillows</h6>
                                        <p class="small text-white-50 mb-0">Ultra Minimalist</p>
                                    </div>
                                </div>
                            </div>
                            <div class="d-flex gap-3 mt-4">
                        ...
                        <div class="col-xl-6 col-lg-8 text-start">
                            ...
                            <div class="row g-4 mb-5 text-start">
                                <div class="col-sm-6 d-flex align-items-center gap-3">
                                    ...
                                    <div>
                                        <h6 class="fw-bold mb-0">Rental Solutions</h6>
                                        <p class="small text-white-50 mb-0">Flexible Plans</p>
                                    </div>
                                </div>
                                <div class="col-sm-6 d-flex align-items-center gap-3">
                                    ...
                                    <div>
                                        <h6 class="fw-bold mb-0">After-Sales Support</h6>
                                        <p class="small text-white-50 mb-0">24/7 Assistance</p>
                                    </div>
                                </div>
                            </div>
                            <div class="d-flex gap-3 mt-4">
